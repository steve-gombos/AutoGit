...
namespace AutoGit.WebHooks.Models
{
    ...
    public enum Action
    {
        ...
        [EnumMember(Value = "rerequested")] ReRequested,
        ...
        [EnumMember(Value = "closed_by_user")] ClosedByUser,
        ...
        [EnumMember(Value = "unsuspend")] Unsuspend,
        ...
        [EnumMember(Value = "edited")] Edited,

        [EnumMember(Value = "pinned")] Pinned,

        [EnumMember(Value = "unpinned")] Unpinned,
        ...
        [EnumMember(Value = "labeled")] Labeled,

        [EnumMember(Value = "unlabeled")] Unlabeled,

        [EnumMember(Value = "locked")] Locked,

        [EnumMember(Value = "unlocked")] Unlocked,

        [EnumMember(Value = "transferred")] Transferred,

        [EnumMember(Value = "milestoned")] Milestoned,

        [EnumMember(Value = "demiledstoned")] Demilestoned,

        [EnumMember(Value = "purchased")] Purchased,

        [EnumMember(Value = "pending_change")] PendingChange,
        ...
        [EnumMember(Value = "converted")] Converted,
        ...
        [EnumMember(Value = "synchronize")] Synchronize,
        ...
        [EnumMember(Value = "prereleased")] PreReleased,

        [EnumMember(Value = "released")] Released,

        [EnumMember(Value = "archived")] Archived,

        [EnumMember(Value = "unarchived")] Unarchived,

        [EnumMember(Value = "publicized")] Publicized,

        [EnumMember(Value = "privatized")] Privatized,

        [EnumMember(Value = "dismiss")] Dismiss,
        ...
        [EnumMember(Value = "performed")] Performed,

        [EnumMember(Value = "tier_changed")] TierChanged,
